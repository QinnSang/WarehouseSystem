...
public class ExpenseDetailController {
    ...
    @ResponseBody
    public Map<String,Object> queryByOrderId(@ModelAttribute ExpenseDetail expenseDetail){
        List<ExpenseDetail> expenseDetailList=expenseDetailService.queryByOrderId(expenseDetail);
