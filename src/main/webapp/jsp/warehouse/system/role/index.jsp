...
<script>
    ...
    layui.use(['element','jquery','form','table','layer','soulTable'], function(){
        ...
        var myTable = table.render({
            ...
            , cols: [[ //表头
                {field: 'title', title: '角色名称', fixed: 'left', width: 200, unresize: true},
                {field: 'dynasty', title: '角色编码', width: 140, unresize: true},
                {field: 'author', title: '角色描述', width: 200, unresize: true},
