        ...
        <div style="padding: 15px;">
            ...
            <form class="layui-form" action="${ctx}/contract/add" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label" style = "width:100px"><span style="color: red;">* </span>仓储订单：</label>
                    ...
                    <div class="layui-input-inline" style = "width:200px">
                        <input type="text" class="layui-input" id="shippingTime" placeholder="请选择">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label" style = "width:100px"><span style="color: red;">* </span>货物名称：</label>
                    <div class="layui-input-inline" style="width:220px">
                    ...
                    <label class="layui-form-label "><span style="color: red;">* </span>出库数量：</label>
                    <div class="layui-input-inline" style = "width:200px">
                        <input type="text" class="layui-input" id="recevingNum" placeholder="请输入">
                    </div>
                </div>
                 <div class="layui-form-item">
                     <label class="layui-form-label" style="width:100px" ><span style="color: red;">* </span>运输方式：</label>
                     <div class="layui-input-inline" style = "width:200px">
                     ...
                     <div class="layui-input-inline" style="width:130px">
                         <textarea name="desc" style = "height:10px;width:200px;" placeholder="请输入"  class="layui-textarea"></textarea>
                     </div>
                 </div>
