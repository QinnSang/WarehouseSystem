            ...
            <form class="layui-form" action="${ctx}/contract/add" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" >
                        <input type="tel" name="softwareName"  value="${deliveryType}"class="layui-input" readonly="readonly">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label" style="width:100px">仓库：</label>
                    <div class="layui-input-inline" style="width:130px">
                        <input type="tel" name="softwareName"  value="${warehouse}"class="layui-input" readonly="readonly">
                    </div>
                    <label class="layui-form-label" >库位：</label>
                    <div class="layui-input-inline" style="width:130px">
                        <input type="tel" name="softwareName"  value="${lcoation}"class="layui-input" readonly="readonly">
                    </div>
                 ...
                 <div class="layui-form-item">
                     ...
                     <div class="layui-input-inline" style = "width:130px">
                         <input type="text" class="layui-input" id="startPlace" value="${startPlace}" readonly="readonly">
                     </div>
                 ...
                 <div class="layui-form-item">
                     ...
                     <div class="layui-input-inline" style = "width:130px">
                         <input type="text" class="layui-input" id="carNo" value="${carNo}" readonly="readonly">
                     </div>
                     <label class="layui-form-label" >备注：</label>
                     <div class="layui-input-inline">
                         <textarea name="remark" value="${remark}" style = "height:10px;width:630px;"  class="layui-textarea" readonly="readonly"></textarea>
                     </div>
                 </div>
                    <%--数据表格--%>
